...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | VortX Hub- Premium",
    SubTitle = " (https://discord.gg/TXebwYcPaB)",
    TabWidth = 160,
...
function ShowNotification(String)
    Fluent:Notify({
        Title = "Powered By VortX Hub AI V1.0",
        Content = String,
        Duration = 5
    })
end
